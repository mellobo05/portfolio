...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.overview-item, .project-item, .service-card, .process-step');
...
function displayTools(tools, container) {
        ...
        postsToShow.forEach(post => {
            ...
            postDiv.innerHTML = `
                <div class="post-image">
                    <img src="images/blog/${post.image}" alt="${post.title}" onerror="this.style.display='none'">
    ...
    function openBlogPost(postId) {
        ...
        if (post) {
            ...
            // this would open a dedicated blog post page or modal
...
function initializePage() {
    ...
    switch(page) {
        ...
        case 'blog':
            ...
            break;
        default:
            // Home page or other pages might need specific initialization
            break;
    }
}
});
...
// Initialize typing animation if hero element exists
...
window.addEventListener('scroll', function() {
    ...
    const parallaxElements = document.querySelectorAll('.hero-placeholder, .image-placeholder');
...
function validateField(field) {
    ...
    switch(fieldName) {
        ...
        case 'phone':
            if (value) { // Only validate if phone is provided (optional field)
                const phoneRegex = /^[\+]?[1-9][\d]{0,15}$/;
